    ...
    return (
      ...
      <div className = "yearinchargepage-container">
          <ul  className = "sidebar-container">
            ...
            <button className={activeTab === 2 ? 'active' : ''} onClick={() => handleTabClick(2)}><div><img src={require("F:/Projects/kecpresence/frontend/src/Sources/add-request.png")} alt = "icon"></img><p>Requests</p></div></button>

  ...
  return (
    ...
    <div className = "pages-container">
      <ul  className = "drawer-container">
        ...
        <button className={activeTab === 2 ? 'active' : ''} onClick={() => handleTabClick(2)}><div><img src={require("../Sources/add-user.png")} alt = "icon"></img><p>Add User</p></div></button>
        <button className={activeTab === 3 ? 'active' : ''} onClick={() => handleTabClick(3)}><div><img src={require("../Sources/user-data.png")} alt = "icon"></img><p>User Data</p></div></button>
    ...
    {showChangePasswordPopup &&
      <div className = "popups-container">
        <div className = "popups-box">
          <p className = "popups-header"><b>Change Password</b></p>

            <div className = "popups-input-container">
              <p>Current password</p>
              <input className = "popups-input-container-inputs" type={showpassword ? 'text' : 'password'} value={currentpassword} onChange={handleCurrentPasswordChange}></input>
              
              <p>New password</p>
              <input className = "popups-input-container-inputs" type={showpassword ? 'text' : 'password'} value={newpassword} onChange={handleNewPasswordChange}></input>
              
              <p>Confirm password</p>
              <input className = "popups-input-container-inputs" type={showpassword ? 'text' : 'password'} value={confirmpassword} onChange={handleConfirmPasswordChange}></input>
            ...
            <div className = "popups-buttons-container">
              <button className = "popups-button popups-blue-button" onClick = {handleChangePassword}>Submit</button>
              <button className = "popups-button popups-white-button" onClick = {handleCloseChangePasswordPopup}>Close</button>
            </div>
          </div>
        </div>
      }
        ...
        <div className = "popups-container">
          <div className = "popups-box">
            <p className = "popups-header">Are you sure to logout?</p>
                    ...
                    <div className = "popups-buttons-container">
                        <button className = "popups-button popups-red-button" onClick = {handleLogout}>Yes</button>
                        <button className = "popups-button popups-white-button" onClick = {handleCloseLogoutPopup}>No</button>
                    </div>
                </div>
            </div>
      )}

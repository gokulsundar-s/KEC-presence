...
export default function AdvoicerRequest() {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.post(
          "http://localhost:3003/advoicerrequests",
  ...
  const handleUpdate = useCallback(async (id, status) => {
    ...
    const response = await axios.post("http://localhost:3003/advoicerupdate", {
      objid,
      advoicerstatus,
    });
              ...
              <div className="advoicer-request-main-container">
                <div className="advoicer-request-container">
                  <div className="advoicer-request-lines">
                    ...
                    <p>
                      <b>Leave taken already : </b>
                    </p>
                    <br />
                    <br />

                    <button
                      className="advoicer-accept-button"
                  ...
                  <div className="advoicer-request-lines">
                    ...
                    <p>
                      <b>No. of days requested : </b>
                      {datas.days}
                    </p>
                    <p>
                      <b>OD taken already : </b>
                    </p>
                    <br />
                    <br />

                    <button
                      className="advoicer-reject-button"
